    ...
    <div className="flex-shrink-0 bg-indigo-600">
      <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
        <div className="relative flex h-16">
          ...
          <nav
            aria-label="Top"
            className="mx-12 w-full flex items-center justify-between max-w-7xl px-4 sm:px-6 lg:px-8"
          >
            {/* MOBILE */}
                        ...
                        <Popover.Panel className="absolute inset-x-0 z-10 top-full text-sm text-gray-500">
                          ...
                          <div className="relative bg-white">
                            <div className="mx-auto max-w-7xl px-8">
                              <div className="py-16 row-start-1 grid grid-cols-4 gap-y-10 gap-x-8 text-sm">
                                {categories &&
                                  Object.keys(categories).map((category) => (
                                    <div key={category}>
                                      <p
